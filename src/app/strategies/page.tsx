      ...
      <div className="max-w-7xl">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {strategies.map((strategy) => {
            ...
            const config = version ? parseStrategyConfig(version.config) : null;
            ...
            return (
              ...
              >
                ...
                <dl className="mt-5 grid gap-3 text-sm">
                  ...
                  <Info label="Ranking" value={config ? `${config.ranking.metric} ${config.ranking.direction}` : "-"} />
...
function formatMarketCapRule(config: ReturnType<typeof parseStrategyConfig> | null) {
